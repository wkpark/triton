...
#define dlSymbolName(symbolName)                                               \
  (symbolName##_t) dlsym(dylibHandle, #symbolName)
...
#define dlSymbolName(symbolName)                                               \
  (symbolName##_t) GetProcAddress((HMODULE)dylibHandle, #symbolName)
    ...
    cublasLtMatmulDescSetAttribute =
        dlSymbolName(cublasLtMatmulDescSetAttribute);
    ...
    cublasLtMatmulPreferenceCreate =
        dlSymbolName(cublasLtMatmulPreferenceCreate);
    cublasLtMatmulPreferenceDestroy =
        dlSymbolName(cublasLtMatmulPreferenceDestroy);
    cublasLtMatmulPreferenceSetAttribute =
        dlSymbolName(cublasLtMatmulPreferenceSetAttribute);
    cublasLtMatmulAlgoGetHeuristic =
        dlSymbolName(cublasLtMatmulAlgoGetHeuristic);
    ...
    if (err) {
      throw std::runtime_error("Could not load symbol from `" +
                               std::string(name) + "`: " + std::to_string(err));
    }
#endif
  }
